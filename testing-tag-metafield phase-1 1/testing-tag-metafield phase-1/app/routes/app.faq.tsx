...
const FaqItem = ({ question, answer, icon: Icon, isOpen, onClick }: FaqItemProps) => {
    return (
        ...
        >
            ...
            >
                <div className="p-3 sm:p-4 pt-0 text-sm text-gray-600 leading-relaxed border-t border-transparent">
            ...
            answer: (
                <div className="space-y-3">
                    ...
                    <div className="flex gap-1.5 mt-2 flex-wrap">
                        <span className="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs rounded font-medium border border-blue-100">Products</span>
                        <span className="px-2 py-0.5 bg-green-50 text-green-700 text-xs rounded font-medium border border-green-100">Customers</span>
                        <span className="px-2 py-0.5 bg-purple-50 text-purple-700 text-xs rounded font-medium border border-purple-100">Orders</span>
                        <span className="px-2 py-0.5 bg-orange-50 text-orange-700 text-xs rounded font-medium border border-orange-100">Blog Posts</span>
                    </div>
                </div>
            ),
        },

        {
            ...
            answer: (
                <div className="space-y-3">
                    ...
                    <div className="mt-2">
                        <p className="font-medium text-xs uppercase tracking-wider text-gray-500 mb-1.5">Supported Identifiers</p>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="border border-[#dfe3e8] p-3 rounded-lg bg-white hover:border-gray-400 transition-colors">
                            <h4 className="font-bold text-[#202223] mb-1.5 flex items-center gap-1.5 text-sm">
                                <span className="flex items-center justify-center w-4 h-4 rounded-full bg-gray-100 text-xs">1</span>
                                Specific Items
                            </h4>
                        ...
                        <div className="border border-[#dfe3e8] p-3 rounded-lg bg-white hover:border-gray-400 transition-colors">
                            <h4 className="font-bold text-[#202223] mb-1.5 flex items-center gap-1.5 text-sm">
                                <span className="flex items-center justify-center w-4 h-4 rounded-full bg-gray-100 text-xs">2</span>
                                All Items
                            </h4>
                            <p className="text-sm text-gray-500">
...

        {
            ...
            answer: (
                <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2 bg-orange-50 text-orange-800 p-3 rounded-md border border-orange-100 text-sm">
                ...
                <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <div className="bg-blue-50 p-2.5 rounded-md border border-blue-100">
                            <span className="block text-xs font-bold text-blue-800 uppercase tracking-wide mb-0.5">Time Limit</span>
                            <span className="text-sm text-blue-900">Available for <strong>2 days</strong> after the operation.</span>
                        </div>
                        <div className="bg-blue-50 p-2.5 rounded-md border border-blue-100">
                            <span className="block text-xs font-bold text-blue-800 uppercase tracking-wide mb-0.5">Usage</span>
                            <span className="text-sm text-blue-900">Each operation can be undone <strong>only once</strong>.</span>
                        </div>
                    </div>
                </div>
            ),
...

        {
            ...
            answer: (
                <div className="flex items-start gap-2 bg-yellow-50 p-3 rounded-md border border-yellow-100">
                    ...
                    <div>
                        <p className="font-bold text-yellow-900 mb-0.5 text-sm">Yes, please keep the tab open.</p>
