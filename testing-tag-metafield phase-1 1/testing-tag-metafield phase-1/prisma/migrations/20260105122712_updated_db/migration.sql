...
INSERT INTO "new_ActiveSubscription" ("host", "id", "plan", "popupShown", "shopDomain", "subscriptionId", "updatedAt") SELECT "host", "id", "plan", "popupShown", "shopDomain", "subscriptionId", "updatedAt" FROM "ActiveSubscription";
